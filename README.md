...
![CI](https://github.com/qalipsis/qalipsis-plugin-r2dbc-jasync/actions/workflows/gradle-master.yml/badge.svg)
...
The QALIPSIS plugin for R2DBC using jasync-SQL is distributed under the Apache License 2.0, the terms can be
read [here](./LICENSE).
